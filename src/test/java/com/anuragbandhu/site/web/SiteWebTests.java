...
class SiteWebTests {
    ...
    void resumePreviewAndLatexDownload() throws Exception {
        mockMvc.perform(get("/resume"))
                ...
                .andExpect(content().string(containsString("Professional Summary")))
                .andExpect(content().string(containsString("healthcare interoperability on CareFabric")))
                ...
                .andExpect(content().string(containsString("We Had 20+ AI Agents and No Way to Know If They Were Any Good")))
                ...
                .andExpect(content().string(containsString("BE, CSE")))
